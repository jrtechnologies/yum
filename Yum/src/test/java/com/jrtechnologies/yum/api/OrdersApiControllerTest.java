...
import com.jrtechnologies.yum.api.OrdersApiController;
...
import com.jrtechnologies.yum.service.ChefOrdersService;
import com.jrtechnologies.yum.service.OrdersService;
...
public class OrdersApiControllerTest {
    ...
    private static List<com.jrtechnologies.yum.data.entity.Food> mockFoodList;
    private static List<com.jrtechnologies.yum.data.entity.DailyOrder> mockDailyOrderList;
    private static com.jrtechnologies.yum.data.entity.DailyOrder mockDailyOrder;
    private static Settings mockSettings;
    private static List<com.jrtechnologies.yum.data.entity.DailyMenu> mockDailyMenuList; 
    ...
    public static void initMock() {
        ...
        com.jrtechnologies.yum.data.entity.Food mockFood = new com.jrtechnologies.yum.data.entity.Food(10);
        ...
        com.jrtechnologies.yum.data.entity.Food mockFood2 = new com.jrtechnologies.yum.data.entity.Food(11);
        ...
        com.jrtechnologies.yum.data.entity.DailyMenu mockDailyMenu = new com.jrtechnologies.yum.data.entity.DailyMenu(1);
        ...
        // Adding the first mock DailyMenu instance
        com.jrtechnologies.yum.data.entity.DailyMenu mockDailyMenu2 = new com.jrtechnologies.yum.data.entity.DailyMenu(2);
        ...
        List<com.jrtechnologies.yum.data.entity.OrderItem> mockOrderItemList1 = new ArrayList<>();
        // Adding the first mock DailyOrder instance
        com.jrtechnologies.yum.data.entity.OrderItem mockOrderItem = new com.jrtechnologies.yum.data.entity.OrderItem(new OrderItemId(10, 1));
        ...
        com.jrtechnologies.yum.data.entity.OrderItem mockOrderItem2 = new com.jrtechnologies.yum.data.entity.OrderItem(new OrderItemId(11, 1));
        ...
        // Mock List of OrderItems
        List<com.jrtechnologies.yum.data.entity.OrderItem> mockOrderItemList2 = new ArrayList<>();
        // Adding the first mock DailyOrder instance
        com.jrtechnologies.yum.data.entity.OrderItem mockOrderItem4 = new com.jrtechnologies.yum.data.entity.OrderItem(new OrderItemId(10, 1));
        mockOrderItem4.setFood(mockFood);
        mockOrderItem4.setQuantity(4);
        mockOrderItemList2.add(mockOrderItem4);
        // Adding the second mock DailyOrder instance
        com.jrtechnologies.yum.data.entity.OrderItem mockOrderItem5 = new com.jrtechnologies.yum.data.entity.OrderItem(new OrderItemId(11, 1));
        mockOrderItem5.setFood(mockFood);
        mockOrderItem5.setQuantity(4);
        mockOrderItemList2.add(mockOrderItem5);
        
         // Mock List of OrderItems
        List<com.jrtechnologies.yum.data.entity.OrderItem> mockOrderItemList4 = new ArrayList<>();
        // Adding the first mock DailyOrder instance
        com.jrtechnologies.yum.data.entity.OrderItem mockOrderItem6 = new com.jrtechnologies.yum.data.entity.OrderItem(new OrderItemId(10, 4));
        mockOrderItem6.setFood(mockFood);
        mockOrderItem6.setQuantity(4);
        mockOrderItemList4.add(mockOrderItem6);
        // Adding the second mock DailyOrder instance
        com.jrtechnologies.yum.data.entity.OrderItem mockOrderItem7 = new com.jrtechnologies.yum.data.entity.OrderItem(new OrderItemId(11, 4));
        ...
        // Adding the first mock DailyOrder instance
        com.jrtechnologies.yum.data.entity.DailyOrder mockDailyOrder1 = new com.jrtechnologies.yum.data.entity.DailyOrder(1);
        ...
        // Adding the second mock DailyOrder instance
        com.jrtechnologies.yum.data.entity.DailyOrder mockDailyOrder2 = new com.jrtechnologies.yum.data.entity.DailyOrder(2);
        ...
        com.jrtechnologies.yum.data.entity.DailyOrder mockDailyOrder3 = new com.jrtechnologies.yum.data.entity.DailyOrder(3);
        ...
        com.jrtechnologies.yum.data.entity.DailyOrder mockDailyOrder4 = new com.jrtechnologies.yum.data.entity.DailyOrder(4);
        ...
        // Mock List of OrderItems
        List<com.jrtechnologies.yum.data.entity.OrderItem> mockOrderItemList = new ArrayList<>();
        // Adding the first mock DailyOrder instance
        com.jrtechnologies.yum.data.entity.OrderItem mockOrderItem3 = new com.jrtechnologies.yum.data.entity.OrderItem(new OrderItemId(10, 1));
        mockOrderItem3.setFood(mockFood);
        mockOrderItem3.setQuantity(6);
        mockOrderItemList.add(mockOrderItem3);        
        
         // Adding the first mock DailyOrder instance
        mockDailyOrder = new com.jrtechnologies.yum.data.entity.DailyOrder(1);
