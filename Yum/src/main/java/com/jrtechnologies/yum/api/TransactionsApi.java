...
public interface TransactionsApi {
    ...
    @ApiOperation(value = "", notes = "Get user's transactions", response = Transaction.class, responseContainer = "List", authorizations = {
    ...
    @CrossOrigin        
    ResponseEntity<Object> transactionsIdGet(@ApiParam(value = "",required=true ) @PathVariable("id") Long id) throws ApiException;
