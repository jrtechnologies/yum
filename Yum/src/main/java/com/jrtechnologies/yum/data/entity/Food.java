...
import com.jrtechnologies.yum.data.converter.BooleanConverter;
...
public class Food {
 ...
 // This constructor is needed for mock data, when the database is not here to autogenerate the id
    ...
    public com.jrtechnologies.yum.api.model.Food toDtoFood() {
        
        com.jrtechnologies.yum.api.model.Food dto = new com.jrtechnologies.yum.api.model.Food();
