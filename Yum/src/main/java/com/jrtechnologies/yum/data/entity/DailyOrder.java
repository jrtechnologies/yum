...
//    
    ...
    public com.jrtechnologies.yum.api.model.DailyMenu toDtoDailyMenu() {
        com.jrtechnologies.yum.api.model.DailyMenu dto = new com.jrtechnologies.yum.api.model.DailyMenu();
        dto.setId(dailyMenu.getId());
        dto.setDate(dailyMenu.getDate());
        dto.setOrderId(dailyOrderId);
        dto.setLastEdit(new com.jrtechnologies.yum.api.model.LastEdit(dailyMenu.getLastEdit(), dailyMenu.getVersion()));
