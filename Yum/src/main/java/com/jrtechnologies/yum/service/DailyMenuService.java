...
import com.jrtechnologies.yum.api.model.DailyMenuChef;
import com.jrtechnologies.yum.api.model.DailyMenuEdit;
import com.jrtechnologies.yum.api.model.DailyMenusFoods;
import com.jrtechnologies.yum.api.model.LastEdit;
import com.jrtechnologies.yum.api.model.NewDailyMenu;
...
public class DailyMenuService
{
    ...
    public LastEdit dailyMenusIdPut(Long dailyMenusId, DailyMenuEdit dailyMenu) throws ApiException
    {
        ...
        for (Food food : foodsEntity)
            ...
            {
                List<com.jrtechnologies.yum.data.entity.OrderItem> orderItems = orderItemRep.findByFoodIdAndDailyOrderIn(food.getId(), dailyMenuEntity.getDailyOrders());
...
//            getDailyMenuChef.setLastEdit(dateNow);
    ...
    public DailyMenuChef getDailyMenuChef(LocalDate currentDay)
    {
        ...
        if (dailyMenuEntity != null)
        {
            ...
            {
                com.jrtechnologies.yum.api.model.Food food = new com.jrtechnologies.yum.api.model.Food();
    ...
    public com.jrtechnologies.yum.api.model.Food getModelFood(Food food)
    {
        com.jrtechnologies.yum.api.model.Food foodDTO = new com.jrtechnologies.yum.api.model.Food();
    ...
    public void dailyMenusIdDelete(Long id) throws ApiException {
        ...
        for( DailyOrder dailyOrder : dailyMenuEntity.getDailyOrders()){
            ...
            List<com.jrtechnologies.yum.data.entity.OrderItem> orderItems = dailyOrder.getOrderItems();
            orderAmount = new BigDecimal(0);
            for(com.jrtechnologies.yum.data.entity.OrderItem orderItem : orderItems){ 
                com.jrtechnologies.yum.data.entity.Food foodEntity = orderItem.getFood();
