...
//        System.out.println("token:" + token);
        ...
        org.bootcamp.yum.data.entity.User userDAO = userRepo.findById(clientUserId);               
    ...
    public ResponseEntity<Void> settingsPictureDelete() throws ApiException {
        org.bootcamp.yum.data.entity.User user = userRepo.findById((Long) SecurityContextHolder.getContext().getAuthentication().getPrincipal());
        if(user==null){
