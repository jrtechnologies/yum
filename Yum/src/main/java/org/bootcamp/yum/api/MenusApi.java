...
public interface MenusApi {
    ...
    @CrossOrigin          
    ResponseEntity<Object> menusMonthlyGet() throws ApiException, Exception;
    ...
    @RequestMapping(value = "/menus/monthly/{monthyear}",
        ...
        method = RequestMethod.GET)
    @CrossOrigin          
    ResponseEntity<Object> menusMonthlyMonthyearGet(@ApiParam(value = "ex. 12-2016",required=true ) @PathVariable("monthyear") String monthyear) throws ApiException, Exception;
    ...
    @RequestMapping(value = "/menus/weekly",
        ...
        method = RequestMethod.GET)
    @CrossOrigin          
    ResponseEntity<Object> menusWeeklyGet() throws ApiException, Exception;
    ...
    @RequestMapping(value = "/menus/weekly/{week}",
        ...
        method = RequestMethod.GET)
    @CrossOrigin          
    ResponseEntity<Object> menusWeeklyWeekGet(@ApiParam(value = "ex. 02-2017",required=true ) @PathVariable("week") String week) throws ApiException, Exception;
